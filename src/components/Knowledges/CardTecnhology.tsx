...
const CardTecnhology = ({ name, icon }: CardTecnhologyProps) => {
    const Icon = icon;
    return (
        <li className="group text-white uppercase font-semibold text-sm text-white-100 border border-blue-100 rounded py-6 shadow-card-knowledges transition-transform duration-200 hover:scale-[1.05] intervalCardReveal" >
